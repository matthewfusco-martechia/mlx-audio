...
import MLXNN                                                                                                                                              
  ...
  public static var customVoiceDirectory: URL?                                                                                                                                                                                                                                                  
    ...
    static func loadVoice(_ voice: TTSVoice) -> MLXArray {                                                                                                  
      ...
      if let customDir = customVoiceDirectory {                                                                                                             
        let customPath = customDir.appendingPathComponent("\(file).\(ext)").path                                                                            
        if FileManager.default.fileExists(atPath: customPath) {                                                                                             
          print("[VoiceLoader] Loading voice from custom path: \(customPath)")                                                                              
          return try! read3DArrayFromJson(file: customPath, shape: [510, 1, 256])!                                                                          
        }                                                                                                                                                   
      }                                                                                                                                                     
